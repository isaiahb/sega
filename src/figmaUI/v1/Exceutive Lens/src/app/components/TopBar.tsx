...
import { GlassesPreviewModal } from '@/app/components/GlassesPreviewModal';
...
export const TopBar: React.FC<TopBarProps> = ({ sidebarOpen, setSidebarOpen, title, onNavigate }) => {
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList>
          ...
          <CommandGroup heading="Navigation">
            ...
            <CommandItem onSelect={() => { onNavigate?.('meetings'); setOpen(false); }}>Go to Meetings</CommandItem>
            <CommandItem onSelect={() => { onNavigate?.('research'); setOpen(false); }}>Go to Research</CommandItem>
