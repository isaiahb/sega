...
import heroImage from 'figma:asset/034babc6454a87b85d1fd41d31bfcd229efe1bd1.png';
    ...
    <section className="h-full w-full relative flex flex-col justify-center px-6 lg:px-8 overflow-hidden pt-12 lg:pt-16">
      ...
      <div className="max-w-[1440px] w-full mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-center h-auto">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left z-20 max-w-xl mx-auto lg:mx-0">
            ...
            >
                <button className="w-full sm:w-auto px-8 py-4 bg-zinc-900 text-white rounded-full font-bold hover:bg-zinc-800 transition-all hover:translate-y-[-1px] hover:shadow-xl active:translate-y-[1px] flex items-center justify-center gap-2 text-sm md:text-base">
                    See the demo
                    <ArrowRight className="w-4 h-4" />
                </button>
                <button className="w-full sm:w-auto px-8 py-4 bg-white border border-zinc-200 text-zinc-600 rounded-full font-bold hover:text-zinc-900 hover:border-zinc-300 transition-all active:scale-95 text-sm md:text-base">
                    Log in
                </button>
            </motion.div>
