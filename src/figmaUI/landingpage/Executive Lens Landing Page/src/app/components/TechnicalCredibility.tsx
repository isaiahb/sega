import { ArrowRight, ShieldCheck, Database, FileOutput, Send, Twitter } from "lucide-react";
import resendLogo from 'figma:asset/d5f9b752eb89871a52e895172f51ec5cfb53cc8f.png';
import firecrawlLogo from 'figma:asset/e6210c94243b30b4d2c1d25dfda0aaf9a4b0a383.png';
import reductoLogo from 'figma:asset/0a1142e339beff716e6955688416b77c5dcfec5b.png';
        ...
        <div className="bg-zinc-900 rounded-[2rem] p-8 md:p-12 text-center relative overflow-hidden flex flex-col justify-center items-center shadow-2xl ring-1 ring-black/5">
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                    <button className="px-6 py-3 bg-white text-zinc-900 rounded-full font-bold hover:bg-zinc-100 transition-all shadow-xl hover:scale-105 active:scale-95 w-full sm:w-auto text-sm">
                        See the demo
                    </button>
                    <button className="px-6 py-3 bg-transparent border border-zinc-700 text-white rounded-full font-medium hover:bg-zinc-800 transition-all active:scale-95 w-full sm:w-auto text-sm">
                        Log in
                    </button>
                </div>
            </div>
...
function InfraCard({ logoSrc, alt, hover, desc }: { logoSrc: string, alt: string, hover: string, desc: string }) {
    return (
        <div className={`bg-white rounded-xl p-6 border border-zinc-200 shadow-sm transition-all group ${hover} hover:shadow-md h-full flex flex-col`}>
