    ...
    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden shadow-sm h-full relative group transition-all duration-500">
      ...
      <div className={clsx(
          ...
          <div className="relative w-48 h-16 my-2 z-10 transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-2">
            <div className="w-full h-full bg-gradient-to-r from-zinc-300 via-zinc-400 to-zinc-300 dark:from-zinc-600 dark:via-zinc-500 dark:to-zinc-600 rounded-full opacity-80" />
          </div>
      ...
      <div className={clsx(
          "absolute inset-0 flex items-center justify-center transition-all duration-700 ease-out bg-zinc-900",
          isRecording ? "opacity-100 scale-100" : "opacity-0 scale-110 pointer-events-none"
      )}>
          {/* HUD Simulation */}
          <div className="relative w-full h-full p-6 font-mono text-[#00b869]">
             <p className="text-sm leading-relaxed whitespace-pre-wrap break-words animate-in fade-in duration-300">
                 {hudText || "Initializing..."}
